...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">revita-roca documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-96935f23aa35ff6994f77c108aa6180d"' : 'data-target="#xs-components-links-module-AppModule-96935f23aa35ff6994f77c108aa6180d"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-96935f23aa35ff6994f77c108aa6180d"' :
                                            'id="xs-components-links-module-AppModule-96935f23aa35ff6994f77c108aa6180d"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/Feed2Component.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">Feed2Component</a>
                                            </li>
                                            <li class="link">
